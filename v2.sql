...
CREATE TRIGGER payment_details_updated_at AFTER UPDATE ON payment_details WHEN old.updated_at < CURRENT_TIMESTAMP BEGIN
    UPDATE payment_details SET updated_at = CURRENT_TIMESTAMP WHERE id = old.id;
END;
